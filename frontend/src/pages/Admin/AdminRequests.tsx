...
const AdminRequests: React.FC = () => {
  ...
  const fetchRequests = async () => {
    try {
      ...
      const url = `/api/waste/admin/requests${queryParams.toString() ? `?${queryParams.toString()}` : ''}`;
      ...
      <div className="mb-6">
        ...
        <div className="mt-4 bg-white p-4 rounded-lg shadow">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Request Created From</label>
              <input
                type="date"
                value={fromDate}
            ...
            {/* Request Created To */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Request Created To</label>
              <input
                type="date"
                value={toDate}
